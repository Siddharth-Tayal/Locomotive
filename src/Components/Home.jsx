...
function Home() {
  return (
    ...
    >
      {/* bg-[#0e1538] */}
      <motion.div className="  flex flex-col items-start justify-center px-6 lg:pl-40 pt-20 md:pb-11 max-h-[70vh] w-screen text-zinc-100  overflow-hidden ">
        <motion.div
          initial={{ x: 5000 }}
          animate={{ x: 0 }}
        ...
        >
          ...
          <p className=" text-xl sm:text-2xl my-2 flex items-center justify-start gap-1 h-fit ">
            ...
            <motion.img
              ...
              animate={({ height: "100%" }, { width: "150px" })}
              className=" bg-blend-color-burn h-[50px] object-contain"
      ...
      <motion.div className="  min-h-[30vh] flex w-full items-end justify-evenly gap-8 pt-[50px] p-3 flex-wrap">
        ...
        <div className=" flex flex-col gap-2 items-center justify-center text-white ">
          <IoCalendarNumberSharp className=" text-[40px] md:text-[80px] text-white " />{" "}
          <div className=" flex items-center gap-1 justify-center">
            <Countup
              className=" font-semibold text-base md:text-2xl"
              start={0}
          ...
          <p className=" text-sm md:text-xl">Year Experience</p>
        </div>{" "}
        <div className=" flex flex-col gap-2 items-center justify-center text-white">
          <GrGroup className=" text-[40px] md:text-[80px] text-white " />
          <div className=" flex items-center gap-1 justify-center">
            <Countup
              className=" font-semibold text-base md:text-2xl"
              start={0}
          ...
          <p className=" text-sm md:text-xl">Total Clients</p>
        </div>
      </motion.div>
    </motion.div>
  );
