...
function Navbar() {
  return (
    <div className="bg-white backdrop-blur-lg fixed py-2 px-3 w-full top-0 left-0 font-mont z-10 shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] flex items-center scroll-smooth">
